...
public class GpApiUtils {
     ...
     * SCF9K7SS
     */
    private static final String apiUrl = "http://api.fuioupay.com/apisc";
    private static final String devKey = "2dc21bcfb28e4584a4f269c776d6e591";
    private static final String devSecret = "D4CPOKT7";
    ...
    public void setVoiceType(String deviceCode,String voiceType) throws IOException {
        String reqTime = String.valueOf(System.currentTimeMillis());
        String securityCode = SecureUtil.md5(devKey + reqTime + devSecret + deviceCode);
        RequestBody requestBody = new FormBody.Builder()
                .add("reqTime", reqTime)
    ...
    public static void main(String[] args) throws Exception {
        ...
        String device2 = "10843192136537531";
